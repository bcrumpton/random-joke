...
var jokeButton = document.querySelector('#get-joke');
var reveal = document.querySelector('#reveal');
var jokeSetup = document.querySelector('#joke-setup');
var jokePunchline = document.querySelector('#joke-punchline');
fetch('https://official-joke-api.appspot.com/jokes/random').then(function (res) {
  return res.json();
}).then(function (joke) {
